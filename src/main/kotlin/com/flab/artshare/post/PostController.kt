...
class PostController(
    ...
    @PostMapping("/post")
    fun createPost(@RequestBody @Valid request: CreatePostReq): ResponseEntity<Void> {
    ...
    @PutMapping("/post/{id}")
    fun updatePost(@PathVariable id: Long, @RequestBody @Valid request: UpdatePostReq): ResponseEntity<PostRes> {
